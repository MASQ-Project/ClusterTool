...
class TestNode:
    ...
    def test_start_bootstrap_node(self, node_commands, printing, mocker):
        subject = Node('booga', self.mock_node_commands)
        self.mock_node_commands.cat_logs.return_value.expect.return_value = 0
        ...
        assert self.mock_print.mock_calls == [
            mocker.call('\tstarting node booga as bootstrap...'),
